...
-- 数据库: `bs-news`
--
CREATE DATABASE IF NOT EXISTS `bs-news` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bs-news`;
...
(1, 'admin', 'admin', '1234', '173654757@qq.com');
